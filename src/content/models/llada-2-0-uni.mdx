...
title: "LLaDA2.0-Uni"
date: 2026-04-23
summary: "A unified multimodal diffusion model that handles visual understanding, image generation, editing, and interleaved reasoning in one architecture with a discrete semantic tokenizer."
